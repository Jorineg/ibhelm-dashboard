...
const defaultBindings: KeyBindings = {
  ...
  navigateDown: { key: 'ArrowDown', description: 'Move selection down' },
  navigateLeft: { key: 'ArrowLeft', description: 'Move selection left' },
  navigateRight: { key: 'ArrowRight', description: 'Move selection right' },
  openLink: { key: 'Enter', description: 'Open item link' },
  openDetail: { key: 'o', description: 'Open detail popup' },
